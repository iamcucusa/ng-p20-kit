 ...
 * Includes all color palettes: blue, green, yellow, cyan, pink, indigo, teal, orange, bluegray, purple, red
 */
const SagaBluePreset = definePreset(Aura, {
  ...
  /**
   * Complete color palette from original saga-blue theme
   */
  primitive: {
    /**
     * Blue palette
